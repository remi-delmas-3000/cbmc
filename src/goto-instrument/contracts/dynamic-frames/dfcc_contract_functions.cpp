    ...
    ns(goto_model.symbol_table)
{
  ...
  // instrument the generated functions for side-effect checking
  ...
  INVARIANT(
    ...
    id2string(spec_assigns_function_id) +
      " shall not contain calls to " CPROVER_PREFIX "obeys_contract");
  ...
  INVARIANT(
    function_pointer_contracts.empty(),
    id2string(spec_frees_function_id) +
      " shall not contain calls to " CPROVER_PREFIX "obeys_contract");
}
