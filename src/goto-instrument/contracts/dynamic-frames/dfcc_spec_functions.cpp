  ...
  int &nof_targets)
{
  ...
  // declare a local var to store targets that are havoced via nondet assignment
  ...
  body.add(goto_programt::make_decl(target_symbol.symbol_expr()));
  ...
  body.add(goto_programt::make_dead(target_symbol.symbol_expr()));
