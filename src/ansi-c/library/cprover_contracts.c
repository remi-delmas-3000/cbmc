...
/// This file defines types functions supporting dynamic frames in contracts.
...
typedef struct __CPROVER_contracts_write_set_t
{
  ...
  /// \brief Object set recording the deallocations (used by predicate is_freed)
...
/// \brief Count the number of leading zeroes in an unsigned long long
...
/// and are later available  to  \ref __CPROVER_contracts_is_freed predicate
